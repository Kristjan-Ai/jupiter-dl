...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", type=str, help=f"Adds a string to the path in conf.py ({dl_dir}) or to the absolute path.", default="")
    parser.add_argument("-s", type=str, help="Absolute path of the download directory", default=dl_dir)
